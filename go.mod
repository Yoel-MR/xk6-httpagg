...
replace github.com/gpiechnik2/xk6-httpagg => github.com/Yoel-MR/xk6-httpagg v0.0.2-0.20221215080025-7111d4fef2e6
...
require (
	...
	github.com/montanaflynn/stats v0.7.0 // direct
